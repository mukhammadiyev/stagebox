...
import productImage from '../assets/product_slide.png'
			...
			>
				<CardContent className='flex flex-col justify-between p-0!'>
					...
					<div className='w-full p-6 flex flex-col'>
						<h1 className='w-full h-11 text-[16px] font-semibold font-montserrat leading-[100%] flex flex-wrap'>
							{product.name}
						</h1>
			...
			>
				<CardContent className='flex flex-col justify-between p-0!'>
					<img
						src={productImage}
						alt=''
						className='w-full h-[220px] rounded-t-[20px]'
					/>
					<div className='w-full p-6 flex flex-col'>
