...
function BrandSlider() {
	...
	return (
		<div className='container mx-auto w-full'>
			<div className='w-full py-10 xl:py-8 2xl:py-16  px-8 lg:px-16 xl:px-25 2xl:px-30'>
				<div className='w-full container mx-auto relative'>
					{/* LEFT ARROW */}
					<button
						ref={prevRef}
						className='block swiper-prev absolute -left-8 top-1/2 -translate-y-1/2 z-50
					...
					<button
						ref={nextRef}
						className='block swiper-next absolute -right-8 top-1/2 -translate-y-1/2 z-50
								[&.swiper-button-disabled>svg]:text-[#B3C0D2]
								[&>svg]:text-[#FF1818] cursor-pointer'
					>
